	        ...
	        <a-table
		        ...
		        <template slot="title" slot-scope="currentPageData">
                    ...
                    <div class="admin_table_handle_btn">
                        <a-button @click="$router.push($moduleUrl('connections/form'))" type="primary" :size="sysSize" icon="plus">添加</a-button>
                ...
                <span slot="action" slot-scope="rows">
                    <a-button icon="edit" type="link" :size="sysSize" @click="$router.push($moduleUrl('connections/form/'+rows.id))">编辑</a-button>
                </span>
            </a-table>
...
export default {
    ...
    data() {
      return {
          ...
          table: {
              actions: {
                  list: this.$api.adminConnections,
                  remove: this.$api.adminConnections
              },
              columns: [
