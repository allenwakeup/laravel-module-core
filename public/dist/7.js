...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    handleSubmit: function handleSubmit() {
      ...
      var api = this.$apiHandle(this.$api.moduleCoreAreas, this.id);
    ...
    get_info: function get_info() {
      ...
      this.$get(this.$api.moduleCoreAreas + '/' + this.id).then(function (res) {
        _this2.info = res.data;
      });
    },
    load_areas: function load_areas(selectedOptions) {
      var _this3 = this;

      var targetOption = selectedOptions[selectedOptions.length - 1];
      var params = {
        type: 'selector',
        selector: this.area_cascader[targetOption.cascader]
      };
      params[targetOption.cascader + '_id'] = targetOption.value;
      targetOption.loading = true;
      this.$get(this.$api.moduleCoreAreas, params).then(function (res) {
        targetOption.loading = false;
        targetOption.children = res.data;
        _this3.areas = _toConsumableArray(_this3.areas);
      });
    },
    ...
    onload: function onload() {
      ...
      this.$get(this.$api.moduleCoreAreas, {
        type: 'selector',
        selector: 'province'
      }).then(function (res) {
          ...
          [
            _c(
              ...
              [
                _c("a-cascader", {
                  ...
                  model: {
                    value: _vm.cascader_area,
                    callback: function($$v) {
                      _vm.cascader_area = $$v
                    },
                    expression: "cascader_area"
                  }
                })
              ],
              1
            ...
            _c(
              ...
              [
                _c("a-input", {
                  model: {
                    value: _vm.info.short,
                    callback: function($$v) {
                      _vm.$set(_vm.info, "short", $$v)
                    },
                    expression: "info.short"
                  }
                })
              ],
              1
            ...
            _c(
              ...
              [
                _c("a-input", {
                  model: {
                    value: _vm.info.display,
                    callback: function($$v) {
                      _vm.$set(_vm.info, "display", $$v)
                    },
                    expression: "info.display"
                  }
                })
              ],
              1
