...
class DataMapController extends Controller
{
    ...
    public function showAssignment ($id)
    {
        ...
        $data = [
            'actions' => [
                'source' => route ("core::admin.data_maps.{$id}.source", ['id' => $id, 'left_id' => ':left_id']),
                'target' => route ("core::admin.data_maps.{$id}.target", ['id' => $id, 'left_id' => ':left_id']),
                'right' => route ("core::admin.data_maps.{$id}.store", ['id' => $id, 'left_id' => ':left_id']),
                'left' => route ("core::admin.data_maps.{$id}.destroy", ['id' => $id, 'left_id' => ':left_id']),
            ],
        ];
        ...
        if (isset ($dataMap))
        {
            ...
            $data ['api'] = route ( "core::admin.data_maps.{$id}.index", ['id' => $id, 'table_left' => $dataMap->left_table]);
