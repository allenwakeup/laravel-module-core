...
class CreateConnectionsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('core_connections', function (Blueprint $table) {
            ...
            $table->string ('database_', 50)->nullable (false)->comment ('数据库名 ');
            $table->string ('username', 50)->nullable ()->comment ('用户名 ');
            $table->string ('password_', 50)->nullable ()->comment ('密码 ');
            ...
            $table->string ('schema_', 20)->nullable ()->default ('public')->comment ('pgsql');
            ...
            $table->string('group_', 50)->default('')->comment('分组 ');
